...
if idf_file and epw_file:
    ...
    if st.button("🔄 Rodar Simulação"):
        with st.spinner("Executando EnergyPlus..."):
            ...
            os.remove(epw_path) # Remove o arquivo .epw após a simulação
            os.remove(idf_path) # Remove o arquivo .idf após a simulação
            ...
            if os.path.exists(output_csv):
                ...
                st.session_state.dataframe_conforto = processar_arquivo_temperatura(df_excel) # Análise de conforto térmico 
